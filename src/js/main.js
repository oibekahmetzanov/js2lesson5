    ...
    .then((resolve) => {
        resolve.forEach((item) => {
                ...
                <div class="main__assort-mainContent-favorites">
                    <span class="main__assort-mainContent-favorites-logo"><svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://localhost:8080/shoes">
                ...
                <div class="main__assort-mainContent-favorites-active">
                    <span class="main__assort-mainContent-favorites-logo-active">
                        <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://localhost:8080/shoes">
                ...
                <p style="margin: 10px 0;" class="main__assort-mainContent-product-gender">${item.gender === 'men' ? 'мужские' : 'женские'}</p>
                ...
                <div class="main__assort-mainContent-product-pricesDesc">
                    ...
                    <div class="main__assort-mainContent-product-pricesDesc-addBask">
                        ...
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://localhost:8080/shoes">
                    ...
                    <span class="main__assort-mainContent-product-pricesDesc-addBask-logo-active">
                        <svg width="12" height="11" viewBox="0 0 12 11" fill="none" xmlns="http://localhost:8080/shoes">
